    ...
    <div class="centered">
        ...
        <c:choose>
            <c:when test="${sessionScope.role=='admin'}">
                ...
                <a href="${contextPath}/setUserRoleByLogin" class="active"><fmt:message
                        key="label.ban_or_unban user"/>|</a>
                <a href="${contextPath}/setStatusByOrderId" class="active"><fmt:message
                        key="label.change.order.status"/> |</a>
                <a href="${contextPath}/listAllOrders" class="active"><fmt:message key="label.List.all.goods"/>|</a>
